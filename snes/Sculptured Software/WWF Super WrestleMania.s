...
0701: cd ff     mov   x,#$ff
0703: bd        mov   sp,x
0704: 8f 6c f2  mov   $f2,#$6c
0707: d8 f3     mov   $f3,x
0709: 8f b0 f1  mov   $f1,#$b0
070c: 8f 20 fa  mov   $fa,#$20
070f: 8f 81 f1  mov   $f1,#$81
0712: 3f d3 0d  call  $0dd3
0715: 8f 00 0b  mov   $0b,#$00
...
07a6: db $ff,$d6,$a0,$80,$6b,$50,$40,$36,$28,$20,$1b,$14,$10,$0e,$0b,$08,$06,$05,$04,$03,$02,$01,$1d,$1c,$1b,$1a,$19,$18,$17,$16,$15,$14,$13,$12,$11,$10,$0f,$0e,$0d,$0c,$0a,$09,$06,$00
...
07fa: db $01,$02,$04,$08,$10,$20,$40,$80
0802: db $fe,$fd,$fb,$f7,$ef,$df,$bf,$7f,$7d,$2c,$3c,$0d,$0f,$1f,$2f,$3f,$4f,$5f,$6f,$7f
...
0c91: da 07     movw  $07,ya
0c93: f8 33     mov   x,$33
0c95: f5 fa 07  mov   a,$07fa+x
0c98: c4 4e     mov   $4e,a
0c9a: 48 ff     eor   a,#$ff
0c9c: c4 4f     mov   $4f,a
0c9e: 8d 00     mov   y,#$00
0ca0: f7 07     mov   a,($07)+y
0ca2: d4 53     mov   $53+x,a
0ca4: c4 34     mov   $34,a
0ca6: 28 20     and   a,#$20
0ca8: f0 05     beq   $0caf
0caa: 09 4e 50  or    ($50),($4e)
0cad: 2f 03     bra   $0cb2
0caf: 29 4f 50  and   ($50),($4f)
...
0cc7: 8d 00     mov   y,#$00
0cc9: f6 0a 08  mov   a,$080a+y
0ccc: c4 f2     mov   $f2,a
0cce: f7 10     mov   a,($10)+y
0cd0: ad 01     cmp   y,#$01
0cd2: f0 04     beq   $0cd8
0cd4: ad 02     cmp   y,#$02
0cd6: d0 09     bne   $0ce1
...
0cf3: fa 51 f3  mov   ($f3),($51)
0cf6: e4 34     mov   a,$34
0cf8: 28 01     and   a,#$01
0cfa: 0d        push  psw
0cfb: 8d 01     mov   y,#$01
0cfd: f7 07     mov   a,($07)+y
0cff: 8e        pop   psw
0d00: d0 08     bne   $0d0a
0d02: f8 33     mov   x,$33
...
0e31: db $6c,$ff,$3d,$00,$4d,$00,$7d,$00,$6d,$ff,$5d,$18,$5c,$00,$2d,$00,$05,$00,$15,$00,$25,$00,$35,$00,$45,$00,$55,$00,$65,$00,$75,$00,$07,$00,$17,$00,$27,$00,$37,$00,$47,$00,$57,$00,$67,$00,$77,$00,$7c,$00,$2c,$00,$3c,$00,$0c,$7f,$1c,$7f,$04,$00,$14,$00,$24,$00,$34,$00,$44,$00,$54,$00,$64,$00,$74,$00,$ff

0e7c: da 27     movw  $27,ya
0e7e: 8d 07     mov   y,#$07
0e80: f7 10     mov   a,($10)+y
...
1398: 1c        asl   a
1399: 5d        mov   x,a
139a: 1f 4c 15  jmp   ($154c+x)
139d: f5 90 05  mov   a,$0590+x
13a0: f0 4c     beq   $13ee
13a2: dd        mov   a,y
13a3: 28 08     and   a,#$08
13a5: 0d        push  psw
...
154c: dw $14db, $14e4, $14f7, $1502, $1516
...
1655: 3f ae 15  call  $15ae
1658: eb 5e     mov   y,$5e
165a: d6 ce 00  mov   $00ce+y,a
165d: 3f b0 15  call  $15b0
...
167f: dw $15b9,$15ee,$15fa,$1606,$1617,$1622,$164b,$1655,$162d,$1640,$15c2,$15b9
...
170e: a9 16 b4  sbc   ($b4),($16)
1711: 16 c3 16  or    a,$16c3+y
1714: ce        pop   x
1715: 16 df 16  or    a,$16df+y
1718: f7 16     mov   a,($16)+y
171a: 8d 93     mov   y,#$93
...
17a8: dw $1345,$134e,$134e,$137b,$1569,$15a7,$1697,$0b5d,$0bd5,$174b,$1746,$173d,$171a,$0790,$0b7c,$0b78,$0b72,$0b6f,$0b69,$0b8b,$0b96