...
0c9a: da 07     movw  $07,ya
0c9c: f8 33     mov   x,$33
0c9e: f5 fc 07  mov   a,$07fc+x
0ca1: c4 4e     mov   $4e,a
0ca3: 48 ff     eor   a,#$ff
0ca5: c4 4f     mov   $4f,a
0ca7: 8d 00     mov   y,#$00
0ca9: f7 07     mov   a,($07)+y
0cab: d4 53     mov   $53+x,a
0cad: c4 34     mov   $34,a
0caf: 28 20     and   a,#$20
0cb1: f0 05     beq   $0cb8
0cb3: 09 4e 50  or    ($50),($4e)
0cb6: 2f 03     bra   $0cbb
0cb8: 29 4f 50  and   ($50),($4f)
...
0cd0: 8d 00     mov   y,#$00
0cd2: f6 0c 08  mov   a,$080c+y
0cd5: c4 f2     mov   $f2,a
0cd7: f7 10     mov   a,($10)+y
0cd9: ad 01     cmp   y,#$01
0cdb: f0 04     beq   $0ce1
0cdd: ad 02     cmp   y,#$02
0cdf: d0 09     bne   $0cea
...
0cfc: fa 51 f3  mov   ($f3),($51)
0cff: e4 34     mov   a,$34
0d01: 28 01     and   a,#$01
0d03: 0d        push  psw
0d04: 8d 01     mov   y,#$01
0d06: f7 07     mov   a,($07)+y
0d08: 8e        pop   psw
0d09: d0 08     bne   $0d13
0d0b: f8 33     mov   x,$33
...
0ddc: db $6c,$ff,$3d,$00,$4d,$00,$7d,$00,$6d,$ff,5d,$18,$5c,$00,$2d,$00,$7c,$00,$2c,$00,$3c,$00,$0c,$7f,$1c,$7f,$ff

0df7: 8d 00     mov   y,#$00
0df9: f6 dc 0d  mov   a,$0ddc+y
0dfc: 68 ff     cmp   a,#$ff
0dfe: f0 0b     beq   $0e0b
0e00: c4 f2     mov   $f2,a
0e02: fc        inc   y
...
153c: dw $14c3,$14cc,$14df,$14ea,$1506
...
1645: 3f 9e 15  call  $159e
1648: eb 5e     mov   y,$5e
164a: d6 ce 00  mov   $00ce+y,a
164d: 3f a0 15  call  $15a0
...
166f: dw $15a9,$15de,$15ea,$15f6,$1607,$1612,$163b,$1645,$161d,$1630,$15b2,$15a9
...
1798: dw $132d,$1336,$1336,$1363,$1559,$1597,$1687,$0b5d,$0bd6,$173b,$1736,$172d,$170a,$0792,$0b7d,$0b79,$0b73,$0b70,$0b6a,$0b8c,$0b97